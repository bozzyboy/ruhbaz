...
- **Micro life event tutarlılığı (SONRA bakılacak — Ozan 2026-06-14):** İki iyileştirme şu an YALNIZ I-Ching/Rün'de var: (a) olayların **konuya anlamsal seçimi** (girilen konu + userStated'e yakınlık), (b) **hayvan/insan ayrımının profil objesinden** gelmesi (snippet null'da pet güvenli). Kahve/el olayları hâlâ rastgele-ama-tekrarsız seçiliyor (konuya anlamsal değil) + hayvan ayrımını memorySnippet'ten türetiyor; numeroloji sayı→grup. Bunları kahve/el + numeroloji'ye yaymak = tutarlılık turu, sonraya (çalışan okumalar → ayrı + cihaz testli). Tarot/rüya/astro micro event kullanmıyor (kapsam dışı). **Şimdilik böyle kalsın (Ozan).**
