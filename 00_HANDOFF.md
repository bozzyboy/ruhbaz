...
**⭐ SONRAKİ CLAUDE SESSION İLK İŞ:** [handoffs/faz4-5-cihaztest1_2026-06-14.md](handoffs/faz4-5-cihaztest1_2026-06-14.md) OKU. **Faz 4.5 KOD TAM (A-D+E1, tag `faz4.5-tam`); cihaz testi-1 işlendi (kriz tespiti genişletildi + 8 düzeltme).** Sıra: **3 teşhis-UX bug'ını çöz** (1) ProfileSettings yavaşlama [199-öğe picker?], (2) rüya persona display bug [reader-seç Suzan vs sağ-üst Ayşe], (3) "hazırlanıyor" geç render — handoff §⏳'de pointer'lar; bir workflow/paralel ajan uygun. Sonra Ozan re-test + tat onayları → Faz 5. Yeni APK GEREKMEZ (JS/TS; reload).
