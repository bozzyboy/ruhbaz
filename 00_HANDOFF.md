...
**En son snapshot:** [handoffs/faz4-5-cihaztest1_2026-06-14.md](handoffs/faz4-5-cihaztest1_2026-06-14.md) (**CİHAZ TESTİ-1 işlendi: kriz tespiti genişletildi + 8 düzeltme; KALAN teşhis-UX bug'ları + tat onayları**) · önceki: [faz4.5-bitti](handoffs/faz4-5-bitti_en-tamamlama_2026-06-13.md) (A-D + E1) · test dok: [21_...](21_FAZ4-5_CIHAZ_TESTLERI_2026-06-13.md) · [20_bulgular](20_FAZ4_CIHAZ_DENEMELERI_2026-06-12.md)

**⭐ SONRAKİ CLAUDE SESSION İLK İŞ — ÖZERK MANDAT (Ozan 2026-06-14):** [handoffs/faz4-5-cihaztest1_2026-06-14.md](handoffs/faz4-5-cihaztest1_2026-06-14.md) OKU (özellikle "ÖZERK MANDAT" + "KRİZ TESTİ ERTELENDİ"). **Ozan uyuyor; SORMADAN bütün fazları tek tek ilerlet.** Sıra: (1) Faz 4.5 cihaz-testi-1 kalan **3 teşhis-UX bug'ı** [ProfileSettings yavaşlama (199-öğe picker?), rüya persona display (reader-seç Suzan vs sağ-üst Ayşe), "hazırlanıyor" geç-render] → `22_FAZ4-5_CIHAZ_TESTLERI_2_<tarih>.md`; (2) sonra **Faz 5 (Konak Akışı) → yol haritası sırası** onay beklemeden, her faza ayrı cihaz test dokümanı. **Krizleri TEK TEK test ETME** (final overall'a; Ozan+Claude birlikte). **Ozan-bloklu işlere girme** (avukat/IAP/fiyat/store/marka/analitik/yasal-final = taslak+"blok: Ozan"). Her adım commit+bekçiler+faz-sonu öz-review. Ultracode açık. Yeni APK gerekmez (JS/TS; reload).
